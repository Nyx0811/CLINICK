...
$login_page_url = '../index.php'; // Common: if Login.php is in the same directory. Adjust to 'index.php' if needed.


// If user is not logged in, or the crucial redirect URL is not set (meaning they didn't come from Login.php properly),
...
// just completed successfully from a user click, or it was already set and Login.php didn't clear it for some reason),
...
// and Login.php intends for the user to make a selection on this page.
