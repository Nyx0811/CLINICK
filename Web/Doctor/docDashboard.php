...
<body>
  <div class="sidebar">
    ...
    <div class="icon" title="Logout" style="margin-top: auto; margin-bottom: 20px;"> <a href="../logout.php" style="color:white; text-decoration:none; display:flex; justify-content:center; align-items:center; width:100%; height:100%;">
