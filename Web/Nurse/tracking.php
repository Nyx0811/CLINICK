        ...
        <tbody>
          ...
          try {
            ...
            $query = "SELECT 
                        ...
                        t.appID,
                        t.trackingID, -- Select trackingID from the outer table t
                        ...
                        (
                            ...
                            AND t2.trackingID != COALESCE(t.trackingID, 0) -- Corrected: t2.trackingID and t.trackingID
              ...
              while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                if ($isTracking) {
                  ...
                  echo "<button class='tracking-btn end-tracking' 
                          ...
                          data-trackingid='" . htmlspecialchars($row['trackingID'] ?? '') . "'
